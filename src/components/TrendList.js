  ...
  return (
    <div className='w-[400px] flex flex-col justify-center items-center'>
        ...
        <nav className='mt-4 bg-gray-100 rounded-2xl mb-4'>
          ...
          <li className='font-bold text-md py-4 hover:bg-gray-200 px-4 cursor-pointer flex justify-between items-center'>#Lionel Messi <span className='hover:bg-blue-200 hover:text-blue-600 p-2 rounded-full'><BsThreeDots/></span></li>
